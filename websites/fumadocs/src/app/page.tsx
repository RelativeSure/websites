        ...
        <div className="container mx-auto px-4 py-12 max-w-6xl">
            ...
            <div className="flex flex-col items-center text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground max-w-4xl mb-8">
                    DevOps | Kubernetes | Helm | GitOps | Linux | Ansible |
                    Python | Automation | CI CD Pipelines | Docker | Innovative
                    Thinker | Rapid Learner
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="mb-6 p-4 bg-accent rounded-lg">
                        ...
                        <Tabs items={["Datatechnician", "IT-Supporter"]}>
                            <Tab value="Datatechnician">
                                <div className="py-2">
                                    <p>
                                        <strong>Degree:</strong> Datatechnician,
                            ...
                            <Tab value="Current">
                                <div className="py-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        DevOps / System Administrator (June 2025
                                        - Present)
                                    </p>
                                </div>
                            </Tab>
                            <Tab value="Previous">
                                <div className="py-2 space-y-4">
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Platform Engineer (Apr 2023 - May
                                            2025)
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Operations Engineer (Dec 2021 - Feb
                                            2023)
                                        </p>
                                        <p className="text-sm text-muted-foreground">
                                            Operations Analyst (Jun 2020 - Dec
                                            2021)
                                        </p>
                                    </div>
                                </div>
                ...
                <div className="border border-border rounded-lg p-6 bg-card">
                    ...
                    <p className="text-sm text-muted-foreground mb-4 p-2 bg-accent rounded">
                        * An asterisk indicates areas where I am actively
                ...
                <div className="border border-border rounded-lg p-6 bg-card">
                    ...
                    <ul className="space-y-4 text-sm">
                        ...
                        <li>
                            <strong>
                                Introduction Badge from PentesterLab
                            </strong>
            ...
            {/* Maintained Repositories Section */}
            <div className="mt-16">
                <h2 className="text-3xl font-bold mb-8 text-center">
                    My Repositories
                </h2>
                <RepositoryBadges repositories={maintainedRepositories} />
            </div>
        </div>
    );
}
