...
const tools = [
  ...
  { title: "SQL → JSON", icon: Database, href: "/tools/sql-to-json", category: "Converters" },
  ...
  { title: "GraphQL", icon: Code2, href: "/tools/graphql-formatter", category: "Formatters" },
  ...
  { title: "Open Graph", icon: Share2, href: "/tools/open-graph-preview", category: "Generators" },
  { title: "Manifest Gen", icon: FileCode2, href: "/tools/manifest-generator", category: "Generators" },
  { title: "Sitemap Gen", icon: Map, href: "/tools/sitemap-generator", category: "Generators" },
  ...
  { title: "Package.json", icon: Package, href: "/tools/package-json-analyzer", category: "Dev Tools" },
