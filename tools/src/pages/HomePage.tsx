...
const tools = [
  { title: "Universal Converter", icon: Shuffle, href: "/converters/converter", category: "Converters" },
  ...
  { title: "JSON → TS", icon: FileJson, href: "/converters/json-to-typescript", category: "Converters" },
  ...
  { title: "Merge PDF", icon: Combine, href: "/pdf/merge", category: "PDF Tools" },
  { title: "Split PDF", icon: Scissors, href: "/pdf/split", category: "PDF Tools" },
  { title: "Organize PDF", icon: FileStack, href: "/pdf/organize", category: "PDF Tools" },
  { title: "PDF Metadata", icon: FileEdit, href: "/pdf/metadata", category: "PDF Tools" },
  { title: "Watermark PDF", icon: Stamp, href: "/pdf/watermark", category: "PDF Tools" },
  { title: "Add Page Numbers", icon: ListOrdered, href: "/pdf/page-numbers", category: "PDF Tools" },
  { title: "Images to PDF", icon: Images, href: "/pdf/images-to-pdf", category: "PDF Tools" },
