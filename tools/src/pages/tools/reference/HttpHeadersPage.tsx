...
const headers = [
  ...
  { name: "Authorization", description: "Authentication credentials for HTTP authentication", category: "Request Headers" },
  ...
  { name: "If-Modified-Since", description: "Conditional request - only send if modified", category: "Request Headers" },
  ...
  // Response Headers
  { name: "Access-Control-Allow-Origin", description: "Specifies origins allowed to access the resource (CORS)", category: "Response Headers" },
  { name: "Access-Control-Allow-Methods", description: "Methods allowed when accessing the resource (CORS)", category: "Response Headers" },
  { name: "Access-Control-Allow-Headers", description: "Headers allowed when accessing the resource (CORS)", category: "Response Headers" },
  ...
  { name: "Expires", description: "Date/time after which the response is considered stale", category: "Response Headers" },
  { name: "Last-Modified", description: "Last modification date of the resource", category: "Response Headers" },
  { name: "Location", description: "Used in redirects or when a resource has been created", category: "Response Headers" },
  ...
  // Security Headers
  { name: "Content-Security-Policy", description: "Controls resources the browser is allowed to load", category: "Security Headers" },
  ...
  { name: "Referrer-Policy", description: "Controls how much referrer information is sent", category: "Security Headers" },
];
