...
const ports = [
  ...
  { port: 20, service: "FTP Data", protocol: "TCP", description: "File Transfer Protocol (Data)", category: "File Transfer" },
  { port: 21, service: "FTP Control", protocol: "TCP", description: "File Transfer Protocol (Control)", category: "File Transfer" },
  ...
  { port: 67, service: "DHCP Server", protocol: "UDP", description: "Dynamic Host Configuration Protocol", category: "Network" },
  ...
  { port: 389, service: "LDAP", protocol: "TCP", description: "Lightweight Directory Access Protocol", category: "Directory" },
  ...
  { port: 3000, service: "Node.js", protocol: "TCP", description: "Node.js development server (common)", category: "Development" },
  ...
  { port: 4000, service: "Development", protocol: "TCP", description: "Common development server port", category: "Development" },
  { port: 5000, service: "Flask/UPnP", protocol: "TCP", description: "Flask development / UPnP", category: "Development" },
  ...
  { port: 8000, service: "HTTP Alternate", protocol: "TCP", description: "Common development server port", category: "Development" },
  ...
  { port: 8888, service: "HTTP Alternate", protocol: "TCP", description: "Common development server port", category: "Development" },
  { port: 9000, service: "Development", protocol: "TCP", description: "Common development server port", category: "Development" },
    ...
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Common network port numbers and services
        </p>
      </div>
                  ...
                  <tbody>
                    {items.map((item, idx) => (
                      <tr key={idx} className="border-b hover:bg-muted">
                        <td className={`p-2 font-mono text-lg font-bold ${getPortColor(item.port)}`}>
                          {item.port}
                        </td>
      ...
      <Card className="mt-6">
        ...
        <CardContent>
          <div className="text-sm space-y-1">
            <div><span className="font-semibold text-blue-600 dark:text-blue-400">0-1023:</span> Well-known ports (system/privileged)</div>
            <div><span className="font-semibold text-green-600 dark:text-green-400">1024-49151:</span> Registered ports (user/application)</div>
            <div><span className="font-semibold text-purple-600 dark:text-purple-400">49152-65535:</span> Dynamic/private ports</div>
          </div>
        </CardContent>
      </Card>
    </div>
