...
const claims = [
  ...
  },
  {
    ...
    description: "Identifies the expiration time (NumericDate)",
    type: "number",
    category: "Registered Claims",
  },
  {
    claim: "nbf",
    fullName: "Not Before",
    description: "Identifies the time before which the JWT must not be accepted (NumericDate)",
    type: "number",
    category: "Registered Claims",
  },
  {
    claim: "iat",
    fullName: "Issued At",
    description: "Identifies the time at which the JWT was issued (NumericDate)",
    type: "number",
    category: "Registered Claims",
  },
  {
  ...
  { claim: "nickname", fullName: "Nickname", description: "Casual name", type: "string", category: "Public Claims" },
  {
    ...
    description: "Shorthand name by which the user wishes to be referred",
    type: "string",
    category: "Public Claims",
  },
  {
  ...
  },
  {
    claim: "updated_at",
    fullName: "Updated At",
    description: "Time the information was last updated (NumericDate)",
    type: "number",
    category: "Public Claims",
  },
  ...
  // Address Claim
  {
    claim: "address",
    fullName: "Address",
    description: "Postal address (structured object)",
    type: "object",
    category: "Public Claims",
  },
  {
    claim: "address.formatted",
    fullName: "Formatted Address",
  ...
  // Common Custom Claims
  {
    claim: "roles",
    fullName: "Roles",
    description: "User roles or permissions",
    type: "array",
  ...
  return (
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Standard and common JWT (JSON Web Token) claims</p>
      </div>
                  ...
                  <tbody>
                    {items.map((item, idx) => (
                      <tr key={idx} className="border-b hover:bg-muted">
                        <td className="p-2 font-mono font-semibold text-primary">{item.claim}</td>
                        <td className="p-2 font-medium">{item.fullName}</td>
                        <td className="p-2 font-mono text-xs text-muted-foreground">{item.type}</td>
      ...
      <Card className="mt-6">
        ...
        <CardContent>
          <div className="text-sm text-muted-foreground">
            ...
            the specified UTC date/time (Unix timestamp).
          </div>
        </CardContent>
      </Card>
    </div>
