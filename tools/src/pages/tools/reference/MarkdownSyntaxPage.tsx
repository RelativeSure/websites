...
const syntax = [
  ...
  { name: "Link with Title", syntax: "[text](url \"title\")", example: "[Link](url \"tooltip\")", category: "Links & Media" },
  ...
  { name: "Image with Title", syntax: "![alt](url \"title\")", example: "![Logo](img.png \"My Logo\")", category: "Links & Media" },
  { name: "Reference Link", syntax: "[text][ref]\\n[ref]: url", example: "[Link][1]\\n[1]: https://url", category: "Links & Media" },
  ...
  { name: "Code with Language", syntax: "```lang\\ncode\\n```", example: "```python\\nprint()\\n```", category: "Code" },

  // Blockquotes
  { name: "Blockquote", syntax: "> quote", example: "> This is a quote", category: "Blockquotes" },
  { name: "Nested Blockquote", syntax: "> quote\\n>> nested", example: "> Quote\\n>> Nested quote", category: "Blockquotes" },
  { name: "Multi-line Quote", syntax: "> line 1\\n> line 2", example: "> First line\\n> Second line", category: "Blockquotes" },
  ...
  // Tables
  { name: "Table", syntax: "| Col1 | Col2 |\\n|------|------|\\n| Data | Data |", example: "| Name | Age |\\n|------|-----|\\n| John | 30 |", category: "Tables" },
  { name: "Aligned Table", syntax: "|:---|:---:|---:|", example: "| Left | Center | Right |\\n|:-----|:------:|------:|", category: "Tables" },
  ...
  // Extended Syntax
  { name: "Footnote", syntax: "text[^1]\\n[^1]: note", example: "Reference[^1]\\n[^1]: Footnote", category: "Extended" },
  { name: "Definition List", syntax: "term\\n: definition", example: "Markdown\\n: Text formatting", category: "Extended" },
    ...
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Complete markdown formatting syntax guide
        </p>
      </div>
      ...
      <Card className="mt-6">
        ...
        <CardContent>
          <div className="text-sm text-muted-foreground space-y-2">
            <div>• Extended syntax features (footnotes, definition lists, etc.) may not be supported in all Markdown parsers</div>
