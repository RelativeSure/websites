...
const properties = [
  // Layout
  {
    ...
    description: "Display type of element",
    category: "Layout",
  },
  {
    property: "position",
  ...
  },
  {
    ...
    values: "stretch | flex-start | center | space-between",
  ...
  { property: "padding", values: "<length>", description: "Inner spacing", category: "Box Model" },
  {
    ...
    description: "Box size calculation",
    category: "Box Model",
  },
  ...
  { property: "background-image", values: "url() | none", description: "Background image", category: "Background" },
  {
    ...
    values: "cover | contain | <length>",
    description: "Background size",
    category: "Background",
  },
  {
    property: "background-position",
    values: "top | center | bottom | <percentage>",
  ...
  {
    property: "transform",
    values: "rotate() | scale() | translate()",
    description: "2D/3D transformations",
    category: "Effects",
  },
  ...
  {
    property: "transition",
    values: "<property> <duration> <timing>",
    description: "Transition shorthand",
    category: "Animation",
  },
  {
    property: "animation",
    values: "<name> <duration> <timing>",
  ...
  return (
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Common CSS properties and values</p>
      </div>
                  ...
                  <tbody>
                    {items.map((item, idx) => (
                      <tr key={idx} className="border-b hover:bg-muted">
                        <td className="p-2 font-mono font-semibold text-primary">{item.property}</td>
                        <td className="p-2 font-mono text-xs text-muted-foreground">{item.values}</td>
