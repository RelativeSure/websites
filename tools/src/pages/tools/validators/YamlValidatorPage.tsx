  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Validate YAML syntax and structure</p>
      </div>
        ...
        <CardContent className="space-y-4">
          ...
          {isValid === true && (
            <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-md">
              <p className="text-sm font-semibold text-green-600 dark:text-green-400">✓ YAML is valid</p>
            </div>
          )}
        </CardContent>
      </Card>
