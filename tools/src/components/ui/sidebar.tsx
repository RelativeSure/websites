...
const SIDEBAR_WIDTH = "clamp(240px, 20vw, 280px)";
const SIDEBAR_WIDTH_MOBILE = "clamp(260px, 75vw, 320px)";
const SIDEBAR_WIDTH_ICON = "clamp(48px, 4vw, 64px)";
    ...
    >
      <div
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "group-data-[collapsible=icon]:w-(calc(--sidebar-width-icon+1rem))"
      ...
      <div
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "p-2 group-data-[collapsible=icon]:w-(calc(--sidebar-width-icon+1rem+2px))"
